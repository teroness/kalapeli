...
>
        ...
        {isEating ? (
          // Huge wide-open mouth when eating - even more exaggerated for visibility
          <path 
            d="M50 20C50 20 60 10 65 20C65 30 50 32 45 24C42 20 38 24 38 24C38 24 45 14 50 20Z" 
            fill="#FF3C62" 
            strokeWidth="2" 
            stroke="#FF3C62"
          />
